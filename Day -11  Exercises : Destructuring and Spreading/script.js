...
//   Add SQL without level to the data science skill sets
  ...
  let newBackEndSkill = {skill:'Express', level: 9}
  let newDataSkill = {skill: 'SQL', level: 8}
  let newDataScienceSkill = 'SQL'

  newStudent.skills.backEnd.push(newBackEndSkill)
  newStudent.skills.dataBase.push(newDataSkill)
  newStudent.skills.dataScience.push(newDataScienceSkill)
  newStudent.skills.frontEnd.push(newSkill)
